...
::
copy "prj\Flash Release\%ORG_NAME%.bin" .\build >NUL 2>&1
.\common\tools\xbin -i:.\build\%ORG_NAME%.bin -o:.\build\fw.bin -v:.\incprj\project.h -a:8192
